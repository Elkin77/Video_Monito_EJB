<%-- 
    Document   : personaEnVideo
    Created on : 25-oct-2017, 12:45:42
    Author     : Ep77
--%>
...
<html>
    ...
    <body class="cuerpo">
        ...
        <div class="contenedorAgregarVideo">
            <fieldset>
                <legend>Agregar Persona a Video</legend>
                <form action="./VideoPorPersona" method="POST">
                    ...
                    <%
                        Vector<Tblpersona> listaPersonas = (Vector<Tblpersona>) request.getAttribute("listaClasifi");

                    %>
                    <div class="arriba">
                        <div class="form-group">
                            <label for="selectColeccion" class="control-label labels">Coleccion</label>
                            <select class="form-control form" id="selectColeccion" name="personaId">
                                <%                        for (Tblpersona pers : listaPersonas) {%>
                                <option value="<%=pers.getIdPersona()%>"><%=pers.getNombre()%> (<%=pers.getPapelVideo()%>)</option>
